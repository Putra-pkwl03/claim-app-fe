...
import ManagerialClaimTable from "../../components/managerial/ManagerialClaimTable";
import { usePageTitle } from "@/context/PageTitleContext";
import { getAllClaimsForManagerial } from "@/lib/api/managerial";
...
export default function ManagerialClaimPage() {
  ...
  useEffect(() => {
    ...
    const fetchClaims = async () => {
      try {
        const res = await getAllClaimsForManagerial();
        // console.log("API response (managerial):", res);
...
<div className="p-6 bg-gray-100 min-h-screen"> 
  <div className="mb-6 mt-12 flex items-center space-x-2"> 
    </div> 
    {loading ? (
