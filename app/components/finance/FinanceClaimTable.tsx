...
import { updateContractorClaimStatus } from "@/lib/api/finance";
...
export default function FinanceClaimTable({ claims, setClaims }: Props) {
  ...
  const [selectedStatus, setSelectedStatus] = useState<
    "" | "approved_finance" | "rejected_finance"
  >("");
  ...
  const statusBadgeMap: Record<string, string> = {
    approved_finance: "bg-blue-100 text-blue-700",
                  ...
                  <td className="px-3 py-2 flex items-center gap-2 text-center">
                    ...
                    <label className="cursor-pointer flex items-center justify-center">
                      <input
                        ...
                        checked={
                          claim.status_contractor_claim === "approved_finance"
                        }
                  ...
                  className={`flex items-center gap-2 px-4 py-2 rounded-xl font-medium text-white transition
                    ${
                      !selectedStatus || loadingSwitch
                        ...
                        : selectedStatus === "approved_finance"
